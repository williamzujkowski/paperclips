...
const mockFile = new Blob(['{"resources":{"clips":100}}'], { type: 'application/json' });
...
describe('EventsSystem', () => {
  ...
  beforeEach(() => {
    ...
    createElementSpy = jest.fn(() => {
      ...
      Object.defineProperty(element, 'className', { writable: true, value: '' });
      Object.defineProperty(element, 'textContent', { writable: true, value: '' });
    ...
    jest.spyOn(eventsSystem, 'showFeedback').mockImplementation((message, type) => {
  ...
  describe('Initialization', () => {
    ...
    test('should set up event delegation', () => {
      ...
      expect(newAddEventListenerSpy).toHaveBeenCalledWith('click', expect.any(Function));
      expect(newAddEventListenerSpy).toHaveBeenCalledWith('change', expect.any(Function));
      expect(newAddEventListenerSpy).toHaveBeenCalledWith('input', expect.any(Function));
      expect(newAddEventListenerSpy).toHaveBeenCalledWith('keydown', expect.any(Function));
    });

    test('should register all required handlers', () => {
      const expectedHandlers = [
        'makeClip', 'buyAutoClipper', 'buyMegaClipper',
        'raisePrice', 'lowerPrice', 'buyAds', 'buyWire', 'toggleWireBuyer',
        'buyProcessor', 'buyMemory', 'toggleCreativity', 'adjustCreativity',
        'allocateProbeStats', 'toggleCombat', 'completeProject',
        'saveGame', 'loadGame', 'resetGame', 'exportSave', 'importSave'
      ];
    ...
    test('should register keyboard shortcuts', () => {
      const expectedShortcuts = [
        ' ', '1', '2', '3', '4', 'arrowup', 'arrowdown',
        'ctrl+s', 'ctrl+l', 'escape'
      ];
  ...
  describe('Event Delegation', () => {
    ...
    test('should handle change events', () => {
      ...
      event.target.dataset.action = 'adjustCreativity';
  ...
  describe('Production Actions', () => {
    ...
    test('should buy auto clipper with feedback', () => {
      ...
      expect(systems.production.buyAutoClipper).toHaveBeenCalled();
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('AutoClipper purchased!', 'success');
    });
    ...
    test('should show error when cannot afford auto clipper', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Cannot afford AutoClipper', 'error');
    });
    ...
    test('should handle mega clipper purchase', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('MegaClipper purchased!', 'success');
    });
  });
  ...
  describe('Market Actions', () => {
    ...
    test('should lower price with limit warning', () => {
      ...
      expect(systems.market.lowerPrice).toHaveBeenCalled();
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Price cannot go lower', 'warning');
    });
    ...
    test('should buy advertising', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Marketing purchased!', 'success');
    });
    ...
    test('should buy wire', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Wire purchased!', 'success');
    });
    ...
    test('should toggle wire buyer', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Wire buyer enabled', 'info');
    });
  });
  ...
  describe('Computing Actions', () => {
    test('should buy processor', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Processor purchased!', 'success');
    });
    ...
    test('should handle processor purchase failure', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Cannot afford processor or trust limit reached', 'error');
    });
    ...
    test('should buy memory', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Memory purchased!', 'success');
    });
    ...
    test('should toggle creativity', () => {
      ...
      expect(systems.computing.setCreativity).toHaveBeenCalledWith(true, 50);
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Creativity enabled', 'info');
    });
  ...
  describe('Combat Actions', () => {
    test('should allocate probe stats successfully', () => {
      ...
      eventsSystem.allocateProbeStats(mockEvent(), mockElement('probeAllocate', 'allocateProbeStats'));
      
      expect(systems.combat.allocateProbeStats).toHaveBeenCalledWith(33, 33, 34);
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Probe stats allocated', 'success');
    });
    ...
    test('should show error for invalid probe stats', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Stats must total 100%', 'error');
    });
    ...
    test('should toggle combat mode', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Combat enabled', 'info');
      
      // Disable combat
      gameState.set('combat.battleEnabled', true);
      eventsSystem.toggleCombat();
      expect(systems.combat.disableCombat).toHaveBeenCalled();
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Combat disabled', 'info');
    });
  });
  ...
  describe('Project Actions', () => {
    test('should complete project successfully', () => {
      ...
      expect(systems.projects.completeProject).toHaveBeenCalledWith('testProject');
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Project completed!', 'success');
    });
    ...
    test('should handle project completion failure', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Cannot complete project', 'error');
    });
  });
  ...
  describe('Save/Load/Export/Import', () => {
    test('should save game successfully', () => {
      ...
      expect(gameState.save).toHaveBeenCalled();
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Game saved!', 'success');
    });
    ...
    test('should handle save failure', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Save failed!', 'error');
    });
    ...
    test('should load game successfully', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Game loaded!', 'success');
    });
    ...
    test('should reset game with confirmation', () => {
      ...
      expect(confirmSpy).toHaveBeenCalledWith('Are you sure you want to reset the game? This cannot be undone.');
      expect(gameState.reset).toHaveBeenCalled();
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Game reset!', 'info');
    });
    ...
    test('should export save successfully', () => {
      ...
      eventsSystem.exportSave(mockEvent(), mockElement('exportBtn', 'exportSave'));
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Save exported!', 'success');
    });
    ...
    test('should handle export failure', () => {
      ...
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Export failed!', 'error');
    });
    ...
    test('should import save successfully', async () => {
      ...
      // Make properties writable
      Object.defineProperty(mockFileInput, 'type', { writable: true, value: '' });
      Object.defineProperty(mockFileInput, 'accept', { writable: true, value: '' });
      Object.defineProperty(mockFileInput, 'onchange', { writable: true, value: null });
      
      createElementSpy.mockReturnValue(mockFileInput);
      global.document.createElement = createElementSpy;
      
      eventsSystem.importSave(mockEvent(), mockElement('importBtn', 'importSave'));
      ...
      expect(gameState.import).toHaveBeenCalledWith('{"resources":{"clips":100}}');
      expect(eventsSystem.showFeedback).toHaveBeenCalledWith('Save imported!', 'success');
    });
  ...
  describe('Feedback System', () => {
    test('should create feedback element if not exists', () => {
      ...
      Object.defineProperty(mockFeedback, 'className', { writable: true, value: '' });
      Object.defineProperty(mockFeedback, 'textContent', { writable: true, value: '' });
    ...
    test('should update existing feedback element', () => {
      ...
      // Make properties writable
      Object.defineProperty(mockFeedback, 'textContent', { writable: true, value: '' });
      Object.defineProperty(mockFeedback, 'className', { writable: true, value: 'feedback' });
      Object.defineProperty(mockFeedback.style, 'display', { writable: true, value: '' });
  ...
  describe('Statistics and Cleanup', () => {
    ...
    test('should cleanup event listeners', () => {
      ...
      expect(removeEventListenerSpy).toHaveBeenCalledWith('click', eventsSystem.boundHandlers.click);
      expect(removeEventListenerSpy).toHaveBeenCalledWith('change', eventsSystem.boundHandlers.change);
      expect(removeEventListenerSpy).toHaveBeenCalledWith('input', eventsSystem.boundHandlers.input);
      expect(removeEventListenerSpy).toHaveBeenCalledWith('keydown', eventsSystem.boundHandlers.keydown);
    });
  });
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    test('should handle confirmReset calling resetGame', () => {
      ...
      expect(confirmSpy).toHaveBeenCalledWith('Reset game? Press OK to confirm, Cancel to continue playing.');
